...
const EXAM_ID = "icse-class-10";
const EXAM_DISPLAY_NAME = "ICSE Class 10";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover the ICSE Class 10 syllabus across all subjects. Align to CISCE assessment patterns.
